...
namespace HW1
{
    public class DBAPI
    {
        ...
        public DBAPI()
        {
            if(!System.IO.File.Exists("E:/messenger_db.sqlite"))
            {
                SQLiteConnection.CreateFile("E:/messenger_db.sqlite");
            }

            conn = new SQLiteConnection("Data Source=E:/messenger_db.sqlite;Version=3;");
            conn.Open();
